...
/**
 * dgus_creality_extui.cpp
 *
 * DGUS implementation written by coldtobi in 2019 for Marlin reword by rommulaner in 2023
 */
...
bool hasPrintTimer = false;
  ...
  void onHomingDone() {
    ScreenHandler.OnHomingDone();
  }

  void onPrintDone() {
    ScreenHandler.OnPrintDone();
  }
