 ...
 */
#if ANY(VYPER_BUILD_IS, VYPER_BUILD_LA_IS, VYPER_BUILD_LA_T_IS, VYPER_BUILD_LA_TE_IS)
  #define INPUT_SHAPING_X
  #define INPUT_SHAPING_Y
#endif
#if EITHER(INPUT_SHAPING_X, INPUT_SHAPING_Y)
  #if ENABLED(INPUT_SHAPING_X)
    #define SHAPING_FREQ_X  35.4        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  72.7       // (Hz) The default dominant resonant frequency on the Y axis.
 ...
 */
#if ANY(VYPER_BUILD_LA, VYPER_BUILD_LA_T, VYPER_BUILD_LA_TE, VYPER_BUILD_LA_IS, VYPER_BUILD_LA_T_IS, VYPER_BUILD_LA_TE_IS)
  #define LIN_ADVANCE
#endif
