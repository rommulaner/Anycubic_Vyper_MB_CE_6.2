...
#if ENABLED(SLOWDOWN_FAN_ON_TEMPDROP)
 ...
 */
//#define E0_AUTO_FAN_PIN -1    //defined in pins_TRIGORILLA_V006.h
 ...
 */
#if ANY(VYPER_BUILD_CJ_IS, VYPER_BUILD_LA_CJ_IS, VYPER_BUILD_LA_JD_IS, VYPER_BUILD_LA_JD_IS_T, VYPER_BUILD_LA_CJ_IS_T, VYPER_BUILD_LA_JD_IS_TE, VYPER_BUILD_LA_CJ_IS_TE)
  ...
  #define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_Y  74.5       // (Hz) The default dominant resonant frequency on the Y axis.
 ...
 */
#if ANY(VYPER_BUILD_LA_JD, VYPER_BUILD_LA_CJ, VYPER_BUILD_LA_JD_T, VYPER_BUILD_LA_CJ_T, VYPER_BUILD_LA_JD_TE, VYPER_BUILD_LA_CJ_TE, VYPER_BUILD_LA_JD_IS, VYPER_BUILD_LA_CJ_IS, VYPER_BUILD_LA_JD_IS_T, VYPER_BUILD_LA_CJ_IS_T, VYPER_BUILD_LA_JD_IS_TE, VYPER_BUILD_LA_CJ_IS_TE)
  #define LIN_ADVANCE
#endif
